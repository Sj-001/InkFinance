...
console.log("INVESTMENT_MANAGER_DUTYID=", keccak256(toUtf8Bytes("dutyID.InvestmentManager")));
const INVESTMENT_MANAGER_DUTYID = "0x1390b27e6a5b27b7b5a53fb7a4cd07990eb7a2e29f06fa68c29b387bcccece29";
