...
async function deploy(){
  ...
  const configManager = await configManagerFactory.attach("0x1c42eD4bD2119CC9465514423b38215D15fa6891");
  ...
  const factoryManager = factoryManagerFactory.attach("0xD814Cd3bCC22741f536d3eCbB458F3fa64eEA489")
