...
async function deploy(){
  ...
  const configManager = await configManagerFactory.attach("0x7d83B1C8FBd2f308B37E84C71904f31A31e5e52E");
  ...
  const factoryManager = factoryManagerFactory.attach("0x58fC8152af495dD3D92Cc2E268aCF46E4677b8C0")
